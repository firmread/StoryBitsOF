...
#import "firmiOSImagePicker.h"

//C++ class implementations

//--------------------------------------------------------------
firmiOSImagePicker::firmiOSImagePicker()
{
	imagePicker = [[firmiOSImagePickerDelegate alloc] initWithPicker:this];
...
//--------------------------------------------------------------
void firmiOSImagePicker::setMaxDimension(int _maxDimension)
{
...
//----------------------------------------------------------------
bool firmiOSImagePicker::openCamera(int camera)
{
	return [imagePicker openCamera:camera];
}
#ifdef __IPHONE_3_1
//----------------------------------------------------------------
bool firmiOSImagePicker::showCameraOverlay() {
	return [imagePicker showCameraOverlay];
}

//----------------------------------------------------------------
bool firmiOSImagePicker::showCameraOverlayWithCustomView(UIView * view) {
    return [imagePicker showCameraOverlayWithCustomView:view];
}

//----------------------------------------------------------------
void firmiOSImagePicker::hideCameraOverlay()
{
	[imagePicker hideCameraOverlay];
}
#endif
//----------------------------------------------------------------
bool firmiOSImagePicker::openLibrary()
{
	return [imagePicker openLibrary];
}
//----------------------------------------------------------------
bool firmiOSImagePicker::openSavedPhotos()
{
	return [imagePicker openSavedPhotos];
}

//----------------------------------------------------------------
void firmiOSImagePicker::close() {
    [imagePicker close];
}

//----------------------------------------------------------------
int firmiOSImagePicker::getOrientation()
{
...
#ifdef __IPHONE_3_1
void firmiOSImagePicker::takePicture()
{
	[imagePicker takePicture];
}
#endif
//----------------------------------------------------------------
void firmiOSImagePicker::loadPixels()
{	
	// load image texture
	CGImageRef photo;
...
//----------------------------------------------------------------
void firmiOSImagePicker::saveImage()
{
...
//----------------------------------------------------------------
@implementation firmiOSImagePickerDelegate

- (id) initWithPicker:(firmCanLoadPixels *) _picker
{
	if(self = [super init])
	{
...
- (BOOL) showCameraOverlayWithCustomView:(UIView *)overlayView {
    ...
    if(isOverlayView) {
        isOverlayView = isOverlayView && [[overlayView class] isSubclassOfClass:[firmOverlayView class]];
    }
    
    if(isOverlayView) {
        overlay = (firmOverlayView *)overlayView;
    } else {
        ...
        overlay = [[firmOverlayView alloc] initWithFrame:overlayFrame];
    }
...
//----------------------------------------------------------- overlay.
@implementation firmOverlayView
