...
//----------------------------------------------------------- overlay.
@interface firmOverlayView : UIView
...
//-----------------------------------------------------------
@interface firmiOSImagePickerDelegate : NSObject <UINavigationControllerDelegate, UIImagePickerControllerDelegate>
{

	UIImagePickerController*			_imagePicker;
	firmOverlayView *						overlay;
	UIImage*							_image;
	...
	firmCanLoadPixels *						cppPixelLoader;
}
...
class firmiOSImagePicker : public firmCanLoadPixels
{
...
protected:
	...
	firmiOSImagePickerDelegate *	imagePicker;
};
